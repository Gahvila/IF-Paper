...
import net.gahvila.inventoryframework.pane.Flippable;
import net.gahvila.inventoryframework.pane.Orientable;
import net.gahvila.inventoryframework.pane.Pane;
import net.gahvila.inventoryframework.pane.component.util.VariableBar;
