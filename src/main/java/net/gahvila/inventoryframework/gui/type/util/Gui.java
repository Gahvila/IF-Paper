...
import net.gahvila.inventoryframework.gui.GuiListener;
import net.gahvila.inventoryframework.gui.type.*;
import net.gahvila.inventoryframework.pane.*;
import net.gahvila.inventoryframework.pane.component.*;
import net.gahvila.inventoryframework.util.TriFunction;
...
public abstract class Gui {
    ...
    static {
        ...
        registerGui("modern-smithing-table",
                (TriFunction<? super Object, ? super Element, ? super Plugin, ? extends Gui>) ModernSmithingTableGui::load);
        registerGui("smoker",
